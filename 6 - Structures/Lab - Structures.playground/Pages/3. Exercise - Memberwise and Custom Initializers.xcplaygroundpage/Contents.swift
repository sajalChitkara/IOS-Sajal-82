...
let favoriteBook = Book(title: "The Alchemist", author: "Paulo Coelho", pages: 208, price: 9.99)
...
let laptop2 = Laptop(screenSize: 15, repairCount: 3, yearPurchased: 2020)

print("Laptop 1 → Screen Size: \(laptop1.screenSize), Repairs: \(laptop1.repairCount), Year: \(laptop1.yearPurchased)")
print("Laptop 2 → Screen Size: \(laptop2.screenSize), Repairs: \(laptop2.repairCount), Year: \(laptop2.yearPurchased)")
/*:
...
let height1 = Height(inches: 65)
let height2 = Height(centimeters: 180)

print("Height1 → Inches: \(height1.heightInInches), Centimeters: \(height1.heightInCentimeters)")
print("Height2 → Inches: \(height2.heightInInches), Centimeters: \(height2.heightInCentimeters)")
