...
var sajal = User(name: "Sajal", age: 25, height: 175.0, weight: 68.0, activityLevel: 4)
print("Name: \(sajal.name), Age: \(sajal.age), Height: \(sajal.height) cm, Weight: \(sajal.weight) kg, Activity Level: \(sajal.activityLevel)")
/*:
...
let trackRun = Distance(meters: 1600)
print("Meters: \(trackRun.meters), Feet: \(trackRun.feet)")

let hillClimb = Distance(feet: 5249.344)
print("Feet: \(hillClimb.feet), Meters: \(hillClimb.meters)")
//:  Now create an instance of `Distance` called `mile`. Use the initializer for meters to set the distance to 1600. Print out the property for feet and verify that it is equal to 5249.344.
let mile = Distance(meters: 1600)
print(mile.feet)
//:  Now create another instance of `Distance` and give it some other distance. Ensure that both properties are set correctly.
let sprint = Distance(feet: 100)
print(sprint.meters)
print(sprint.feet)
/*:
