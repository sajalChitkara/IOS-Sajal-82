...
let internalDivisionResult = 10 / 3
print(internalDivisionResult)
...
let var1 = 10.0
let var2 = 3.0
let divisionResult: Double = var1 / var2
...
let even: Int = 10
let odd: Int = 9
print("Even remainder: \(even % 2)")
print("Odd remainder: \(odd % 2)")
